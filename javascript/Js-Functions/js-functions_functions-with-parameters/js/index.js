...
function logText() {
  ...
  console.log("We need to call the function. Bug Fixed!")
}

console.log("-------------");
console.log("Exercise 2:");

// we need to call the function. bug fixed!.
logText();
/*
...
function logSeparator (exersiceNumbers) {
  console.log('-----------------------');
  console.log(`Exercise ${exersiceNumbers}:`);
}
