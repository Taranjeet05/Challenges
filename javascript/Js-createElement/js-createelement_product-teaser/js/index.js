...
// Function to create and append the new product teaser
function appendProduct() {
  // using a template literal callled interpolation.
  const productHTML = `
  ...
  const lastBuyButton = buyButton[buyButton.length - 1]; // Get the last buy button (the new one)

  lastBuyButton.addEventListener('click', () => {
